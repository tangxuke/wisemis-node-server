 ...
 * 从数据表行创建Model
 * @param {Model} model
 * @param {{name:string,title:string,tablename:string,database:string,column_count:number,order_by:string,system:boolean,auto_focus_field:string,auto_refresh:boolean,pages:string}} row 行数据
 */
